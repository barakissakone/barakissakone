...
📍 Lille, EuraTechnologies &nbsp;|&nbsp; 🗓️ Août 2026 – En cours

- Annotation et traitement de jeux de données d'images (Python, Pandas, Label Studio)
- Entraînement, fine-tuning et évaluation de modèles YOLO / PyTorch
- Optimisation du pipeline d'annotation et suivi de projet (Git, GitHub)
